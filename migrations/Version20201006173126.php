 ...
 */
final class Version20201006173126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE housing (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, type_id INT NOT NULL, status_id INT NOT NULL, user_id INT NOT NULL, short_description VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, room_count SMALLINT NOT NULL, bedroom_count SMALLINT NOT NULL, floor_area DOUBLE PRECISION NOT NULL, INDEX IDX_FB8142C3F5B7AF75 (address_id), INDEX IDX_FB8142C3C54C8C93 (type_id), INDEX IDX_FB8142C36BF700BD (status_id), INDEX IDX_FB8142C3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, housing_id INT NOT NULL, url VARCHAR(255) NOT NULL, alt VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_C53D045FAD5873E3 (housing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(32) NOT NULL, lastname VARCHAR(36) NOT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(180) DEFAULT NULL, zip_code VARCHAR(5) DEFAULT NULL, phone VARCHAR(10) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
