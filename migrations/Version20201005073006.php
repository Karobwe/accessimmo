 ...
 */
final class Version20201005073006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE housing (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, type_id INT NOT NULL, status_id INT NOT NULL, user_id INT DEFAULT NULL, short_description VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, room_count SMALLINT NOT NULL, bedroom_count SMALLINT NOT NULL, floor_area DOUBLE PRECISION NOT NULL, INDEX IDX_FB8142C3F5B7AF75 (address_id), INDEX IDX_FB8142C3C54C8C93 (type_id), INDEX IDX_FB8142C36BF700BD (status_id), INDEX IDX_FB8142C3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
